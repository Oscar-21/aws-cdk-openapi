...
public class BlogLambda extends AbstractCustomLambdaRuntime<ApiStack> {
	...
	public void buildImage(ApiStack stack) {
		 ...
		 */
		BundlingOptions.Builder apiBuilderOptions = BundlingOptions.builder().command(defaultApiPackagingInstructions)
		...
		/*
		 * Declare the asset code that needs to be packaged(bundled)
		 * for the custom java lambda runtime.
		 */
		AssetCode apiCode = Code.fromAsset("../app/",
				AssetOptions.builder()
						.bundling(apiBuilderOptions.command(defaultApiPackagingInstructions).build())
						.build());
		 ...
		 */
		Function apiLambda = new Function(stack, "OpenAPIBlogLambda",
		 ...
		 * the CDK.
		 * 
		 * This Logical ID is referenced in the ../api/openapi.yaml like so:
